...
// АВЛ-дерево, в котором хранятся номера гостиницы
...
// заполнение списка гостей данными
...
// цикл while, с помощью которого происходит работа с пользователем
